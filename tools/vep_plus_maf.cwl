...
id: kf-vep-somatic-annotate-maf
requirements:
...
arguments:
  - position: 1
    ...
    valueFrom: >-
      ...
      --output-maf $(inputs.output_basename).strelka.vep.maf
      --filter-vcf 0
      ...
      && mv input_file.vep.vcf $(inputs.output_basename).strelka.PASS.vep.vcf
      && /ensembl-vep/htslib/bgzip $(inputs.output_basename).strelka.PASS.vep.vcf
      && /ensembl-vep/htslib/tabix $(inputs.output_basename).strelka.PASS.vep.vcf.gz
